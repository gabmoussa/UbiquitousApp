...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private static final String WEATHER_UUID = "uuid";
...
//                    .addOnConnectionFailedListener(this)
    ...
    public void sendWeatherInfoToWearable(double high, double low, int weatherId) {
        ...
        putDataMapRequest.getDataMap().putString(WEATHER_UUID, UUID.randomUUID().toString());
        putDataMapRequest.getDataMap().putString(WEATHER_HIGH, Utility.formatTemperature(getContext(), high));
        putDataMapRequest.getDataMap().putString(WEATHER_LOW, Utility.formatTemperature(getContext(), low));
